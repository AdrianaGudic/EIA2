...
namespace Aufgabe11 {
    ...
    var basketBaumart: string[] = [ "kein Baum ausgewählt", "0"];
    ...
    function createElements(): void {
        ...
        //SubmitButton:
        let button: HTMLDivElement = <HTMLDivElement>document.getElementById("buttonPlace");
    ...
    function warenkorb(_event: Event): void {
        ...
        for (let i: number = 0; i < posten.length; i++) {
            ...
            if (ziel.value == posten[i].name && ziel.id == "selectBaumart") {
            ...
            if (ziel.value == posten[i].name && ziel.id == "selectBeleuchtung") {
